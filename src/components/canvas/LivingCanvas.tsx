    ...
    <div ref={containerRef} className="fixed inset-0 overflow-hidden pointer-events-none" style={{ zIndex: 0 }}>
      ...
      <div
        ...
        style={{
          height: '40%',
          background: `
            linear-gradient(rgba(var(--accent-cyan-rgb), 0.05) 1px, transparent 1px),
            linear-gradient(90deg, rgba(var(--accent-cyan-rgb), 0.05) 1px, transparent 1px)
          `,
      ...
      <svg className="absolute inset-0 w-full h-full" style={{ opacity: 0.03 }}>
        <pattern id="circuit" x="0" y="0" width="200" height="200" patternUnits="userSpaceOnUse">
          <path d="M 0 100 L 80 100 L 80 40 L 120 40 L 120 100 L 200 100" stroke="var(--accent-cyan)" strokeWidth="1" fill="none" />
          <path d="M 100 0 L 100 60 L 160 60 L 160 140 L 100 140 L 100 200" stroke="var(--accent-cyan)" strokeWidth="1" fill="none" />
          <circle cx="80" cy="100" r="3" fill="var(--accent-cyan)" />
          <circle cx="120" cy="40" r="3" fill="var(--accent-cyan)" />
          <circle cx="160" cy="60" r="3" fill="var(--accent-magenta)" />
          <circle cx="100" cy="140" r="3" fill="var(--accent-magenta)" />
        </pattern>
      ...
      <div
        ...
        style={{
          background: 'repeating-linear-gradient(0deg, transparent, transparent 2px, rgba(var(--accent-cyan-rgb), 0.015) 2px, rgba(var(--accent-cyan-rgb), 0.015) 4px)',
          zIndex: 1,
        }}
      />
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(var(--accent-magenta-rgb), 0.05) 0%, transparent 70%)',
          filter: 'blur(60px)',
      ...
      <div
        ...
        style={{
          background: 'radial-gradient(circle, rgba(var(--accent-purple-rgb), 0.03) 0%, transparent 70%)',
          filter: 'blur(80px)',
